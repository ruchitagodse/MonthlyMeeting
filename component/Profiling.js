...
//       SERVICES (MAP → ARRAY)
// --------------------------
const servicesArray = Array.isArray(userData.services)
  ? userData.services
  : userData.services && typeof userData.services === "object"
  ? Object.values(userData.services)   // ← THIS IS THE FIX
  : [];
...
//       PRODUCTS (MAP → ARRAY)
// --------------------------
const productsArray = Array.isArray(userData.products)
  ? userData.products
  : userData.products && typeof userData.products === "object"
  ? Object.values(userData.products)  // ← IMPORTANT FIX
  : [];
